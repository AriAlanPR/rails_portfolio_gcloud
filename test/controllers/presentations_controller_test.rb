...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference("Presentation.count") do
      post presentations_url, params: { presentation: { content: @presentation.content, image: @presentation.image, subtitle: @presentation.subtitle, title: @presentation.title } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { content: @presentation.content, image: @presentation.image, subtitle: @presentation.subtitle, title: @presentation.title } }
