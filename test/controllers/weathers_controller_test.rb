...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference("Weather.count") do
      post weathers_url, params: { weather: { city: @weather.city, description: @weather.description, weather: @weather.weather } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { city: @weather.city, description: @weather.description, weather: @weather.weather } }
